...
class Turn
{
  ...
  public function setById()
  {
    ...
    $query = "SELECT client_id, client_name, description, editedBy, cost, item_ids, day, startTime, duration, location, status FROM " . $this->table_name . "
          WHERE id = ?
          LIMIT 0,1";
  ...
  public function update()
  {
    ...
    $query .= !empty($this->editedBy) ? " editedBy=:editedBy," : "";
  ...
  public function list()
  {
    ...
    // select all query
    $query = "SELECT p.id, p.client_id, p.client_name, p.editedBy, p.cost, p.item_ids, p.description, p.day, p.startTime, p.duration, p.location, p.status FROM " . $this->table_name . " p " . $search_set . " ORDER BY p.day DESC";
